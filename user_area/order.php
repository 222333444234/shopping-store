...
$insert_orders = "insert into user_orders(user_id,amount_due,invoice_number,total_products,order_date,order_status) value('$user_id','$subtotal','$invoice_number','$count_products',NOW(),'$status')";
...
//order pending
$insert_pending_orders = "insert into orders_pending(user_id,invoice_number,product_id,quantity,order_status) value('$user_id','$invoice_number','$product_id','$quantity','$status')";
